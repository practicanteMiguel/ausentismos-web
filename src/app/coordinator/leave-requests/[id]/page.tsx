...
export default async function CoordinatorLeaveRequestDetailPage({
  params,
}: {
  ...
  if (request.supervisorId !== coordinator.uid) notFound();
  ...
  return (
    <div className="mx-auto max-w-5xl space-y-6">
      <Button
        variant="ghost"
        size="sm"
        render={<Link href="/coordinator/leave-requests" />}
        nativeButton={false}
      >
